    ...
    try {
      ...
      const enrichedPatients = backendPatients.map((bp, idx) => {
        ...
        return {
          ...
          avatar: (bp.avatar === '/avatars/ramesh_sharma.png' && !isDemo) ? '' : (bp.avatar || (isDemo && fallbackPatient ? fallbackPatient.avatar : '')),
  ...
  const loginPatient = async (name, age, pin, phoneNumber) => {
    ...
    try {
      ...
      const fullPatient = {
        ...
        avatar: (backendPatient.avatar === '/avatars/ramesh_sharma.png' && !isRamesh) ? '' : (backendPatient.avatar || ''),
  ...
  const setDirectPatientSession = useCallback((patient) => {
    ...
    if (isMeera) {
      ...
      fullPatient = {
        ...
        avatar: (patient.avatar === '/avatars/ramesh_sharma.png' && !isRamesh) ? '' : (patient.avatar || ''),
