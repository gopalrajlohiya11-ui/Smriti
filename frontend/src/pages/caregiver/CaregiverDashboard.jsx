    ...
    >
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="bg-white rounded-2xl p-6 border border-slate-200/90 shadow-[0_1px_3px_rgba(0,0,0,0.03)] flex items-center justify-between">
            ...
            <div className="w-13 h-13 rounded-2xl bg-teal-50 text-teal-800 flex items-center justify-center shrink-0 border border-teal-100">
          ...
          <div className="bg-white rounded-2xl p-6 border border-slate-200/90 shadow-[0_1px_3px_rgba(0,0,0,0.03)] flex items-center justify-between">
            ...
            <div className={`w-13 h-13 rounded-2xl flex items-center justify-center shrink-0 border ${
              ...
              {activeAlertsCount > 0 ? <AlertTriangle className="w-6 h-6 stroke-[2]" /> : <CheckCircle2 className="w-6 h-6 stroke-[2]" />}
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl p-6 border border-slate-200/90 shadow-[0_1px_3px_rgba(0,0,0,0.03)] flex items-center justify-between">
            ...
            <div className="w-13 h-13 rounded-2xl bg-cyan-50 text-cyan-800 flex items-center justify-center shrink-0 border border-cyan-100">
          ...
          <div className="bg-white rounded-2xl p-6 border border-slate-200/90 shadow-[0_1px_3px_rgba(0,0,0,0.03)] flex items-center justify-between">
            <div className="space-y-1.5">
              ...
              <p className="text-xs text-amber-900 font-semibold truncate max-w-[140px]">
                {bestStreakInfo.patientName.split(' ')[0]} (Consistent)
              </p>
            </div>
            <div className="w-13 h-13 rounded-2xl bg-amber-50 text-amber-800 flex items-center justify-center shrink-0 border border-amber-100">
              ...
              {filteredPatients.map((patient) => {
                ...
                return (
                  <div
                    ...
                    className="bg-white rounded-2xl p-6 border border-slate-200/90 shadow-[0_1px_3px_rgba(0,0,0,0.03)] hover:shadow-lg hover:border-teal-600/50 transition-all duration-200 cursor-pointer flex flex-col justify-between gap-5 group relative overflow-hidden"
                  >
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-start gap-4">
                        <div className="relative shrink-0">
                          <img
                            src={patient.avatar}
                            alt={patient.name}
                            className="w-16 h-16 rounded-2xl object-cover border border-slate-200 shadow-xs group-hover:scale-105 transition-transform duration-200"
                          />
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center justify-between gap-1">
                            ...
                            <span className="inline-flex items-center gap-1 text-xs font-bold text-amber-800 bg-amber-50 px-2.5 py-0.5 rounded-md border border-amber-200/80 shrink-0">
                      ...
                      <div className="flex flex-wrap items-center gap-2 pt-1">
                        <span className="text-xs font-bold px-2.5 py-1 bg-teal-50 text-teal-800 rounded-md border border-teal-200/80">
                        ...
                        {patient.hasBiometric && (
                          <span className="text-xs font-bold px-2.5 py-1 bg-emerald-50 text-emerald-800 rounded-md border border-emerald-200 flex items-center gap-1">
                    ...
                    <div className="pt-4 border-t border-slate-100 space-y-3">
                      ...
                      <div className="flex items-center justify-between pt-1.5">
                        ...
                        <span className="text-sm font-bold text-teal-800 group-hover:text-teal-900 inline-flex items-center gap-1 group-hover:translate-x-1 transition-transform">
