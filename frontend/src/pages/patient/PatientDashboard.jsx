        ...
        <div className="bg-white rounded-3xl p-5 sm:p-7 border border-[#E5E0D8] shadow-2xs">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 sm:gap-5">
            ...
            <div className="flex items-center justify-center sm:justify-end gap-2 sm:gap-2.5 flex-wrap sm:flex-nowrap shrink-0">
              ...
              {/* WhatsApp Bot Button (Direct wa.me Link) */}
              <a
                href="https://wa.me/15556680031?text=Hi%20Smriti"
                target="_blank"
                rel="noopener noreferrer"
                className="min-h-[48px] sm:min-h-[56px] px-3.5 sm:px-4 py-2.5 sm:py-3.5 rounded-2xl bg-[#25D366] hover:bg-[#20bd5a] text-white font-black text-xs sm:text-sm flex items-center justify-center gap-2 shadow-2xs hover:shadow-xs transition-all cursor-pointer active:scale-95 shrink-0"
                title="Chat with Smriti on WhatsApp"
                aria-label="WhatsApp Assistant"
              >
                <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor" className="w-5 h-5 fill-current">
              ...
              <button
                type="button"
                onClick={() => window.dispatchEvent(new CustomEvent('smriti_open_chat'))}
                className="min-h-[48px] sm:min-h-[56px] px-3.5 sm:px-4 py-2.5 sm:py-3.5 rounded-2xl bg-[#2C5AA0] hover:bg-[#224780] text-white font-black text-xs sm:text-sm flex items-center justify-center gap-2 shadow-2xs hover:shadow-xs transition-all cursor-pointer active:scale-95 shrink-0"
                title="Open Smriti AI Assistant"
                aria-label="Smriti AI Assistant"
              >
                <MessageCircle className="w-5 h-5" />
                <span>{isHindi ? "स्मृति AI" : "AI Assistant"}</span>
              </button>
